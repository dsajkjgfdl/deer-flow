...
test("surfaces display-as-assistant tool messages as assistant bubbles", () => {
  const messages = [
    {
      id: "human-1",
      type: "human",
      content: "Recommend someone",
    },
    {
      id: "ai-1",
      type: "ai",
      content: "",
      tool_calls: [
        { id: "tool-1", name: "text2cypher_answer_question", args: {} },
      ],
    },
    {
      id: "tool-1-result",
  ...
  expect(groups[2]?.messages[0]?.content).toBe("首推：候选人A");
});
