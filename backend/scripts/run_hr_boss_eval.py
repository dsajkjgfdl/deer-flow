...
os.environ.setdefault("DEER_FLOW_PROJECT_ROOT", str(REPO_ROOT / "backend"))
...
TEXT2CYPHER_EMPLOYEE_PROFILE_TOOL = "text2cypher_get_employee_profile"
...
TEXT2CYPHER_EMPLOYEE_PROFILE_ROUTE = [TEXT2CYPHER_EMPLOYEE_PROFILE_TOOL]
...
TEXT2CYPHER_ROUTES = [TEXT2CYPHER_FAST_ROUTE]
TERM_RESOLUTION_ROUTES = [TEXT2CYPHER_FAST_ROUTE]
GRAPHRAG_ROUTES = [
...
def expected_routes_for(track: str) -> list[list[str]]:
    ...
    if track == "boss.e2e":
        return (
            TEXT2CYPHER_ROUTES
            + [TEXT2CYPHER_EMPLOYEE_ROUTE, TEXT2CYPHER_EMPLOYEE_PROFILE_ROUTE]
            + [[route] for route in GRAPHRAG_ROUTES]
        )
    return []
