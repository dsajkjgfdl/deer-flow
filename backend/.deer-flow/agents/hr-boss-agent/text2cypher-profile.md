...
Text2Cypher 在生成 Cypher 前会先执行字段值纠错转换，并把结果记录在 `term_resolution` 中。该阶段只负责把老板口语中的公司、部门、岗位、职称等业务词映射到图谱中真实存在的字段值，不能替代下面的组织、职称、当前员工等业务口径。
...
老板查询中的“员工”“人员”“公司人数”“部门人数”“平均年龄”“名单”等默认全部指当前员工。除非用户明确指定离职、辞职、历史、曾
