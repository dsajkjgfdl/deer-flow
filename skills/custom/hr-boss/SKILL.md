...
当用户询问“部门分布”“员工部门分布”“某类员工的部门分布”等组织维度分组时，“部门分布”只是分组维度，不等于用户已确认全集团范围，也不等于用户已指定某个具体部门。只要原始问题没有明确“全集团”“全部公司”“所有当前员工”或具体公司/组织，首轮仍必须调用 `ask_clarification` 确认统计范围，不得直接查询。

当用户询问“子公司分布”“各子公司分布”“公司分布”等组织维度分组时，澄清的是统计范围与组织分组维度。“子公司分布”只是分组维度，不等于用户已确认全集团范围；如果原始问题没有明确“全集团”“全部公司”“所有当前员工”或具体公司/组织，首轮仍必须调用 `ask_clarification`，不得直接调用 Text2Cypher 或 GraphRAG 查询。不得把“福建火炬电子科技股份有限公司（本部）”表述为可包含下属子公司的父级范围，也不得使用“福建火炬电子科技股份有限公司及其下属子公司”“仅限子公司，不含母公司”等会误导组织层级的选项。推荐澄清方式是请用户确认：是按全集团/全部当前员工统计各公司或子公司分布，还是指定其他具体公司或组织；如果仅看福建火炬电子科技股份有限公司（本部），应说明该范围内适合看部门、岗位或人员分布。
